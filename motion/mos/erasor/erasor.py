...
class Erasor():
    ...
    def prepare_frame_data(self, frame_id):
        ...
        self.points_q = self.pcls[frame_id][:, :3]
        ...
        self.volume_mask = Er.crop_volume_of_interest(self.points_m, self.pose, koef=1.5)
    ...
    def calculate_heights_sector(self, points, N_r, N_s):
        ...
        # delta_h_point = Sector_bev.transfer_features_to_points(sector_coors, delta_h_grid)
    ...
    def calculate_scan_ratio(self, delta_h_grid_m, delta_h_grid_q):
        ...
        # Maybe here something wrong? IDK
...
if __name__ == '__main__':
    ...
    data = dataset.prep_dataset.get_base_data(sequence=sequence, start=0, end=30)
    ...
    p = np.concatenate((Er.points_q, Er.points_m))
